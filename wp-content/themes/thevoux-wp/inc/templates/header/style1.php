...
<header class="header style1 <?php echo ($header_boxed === 'on' ? 'boxed' : ''); ?>">
	<div class="header_top cf">
		<div class="row full-width-row align-middle">
			...
			<div class="small-6 large-3 columns logo text-center">
				<a href="<?php echo home_url(); ?>" class="logolink" title="<?php bloginfo('name'); ?>">
					<img src="<?php echo esc_url($logo); ?>" class="logoimg" alt="<?php bloginfo('name'); ?>"/>
                        ...
                        <div class="small-3 large-6 columns social-holder-1 <?php echo esc_attr($social_style = ot_get_option('header_socialstyle', 'style1')); ?>">
				<img src="http://homemadesolutions.in/wp-content/uploads/2017/04/728x90.jpg" />
			</div>

...
add_filter( 'better-framework/metabox/bs_review_metabox/css', 'better_reviews_metabox_css', 10 );

if ( ! function_exists( 'better_reviews_metabox_css' ) ) {
	/**
	 ...
	 * @return array
	 */
	function better_reviews_metabox_css( $fields ) {

		include Better_Reviews::dir_path( 'includes/options/metabox-css.php' );

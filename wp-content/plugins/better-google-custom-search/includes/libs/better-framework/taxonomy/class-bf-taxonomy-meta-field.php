...
class BF_Taxonomy_Meta_Field {
	...
	public function save_fields( $term_id ) {
		...
		foreach ( BF_Taxonomy_Core::get_metabox_fields( $this->metabox_id ) as $key => $field ) {
	...
	public static function ajax_tab( $tab_id, $metabox_id, $term_id ) {
		...
		foreach ( $metabox['fields'] as $key => $field ) {
			...
			} else if ( $field['type'] !== 'tab' && $field['type'] !== 'group' ) {
